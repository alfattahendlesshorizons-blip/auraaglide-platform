import type { BusinessRealityIconKey } from "./business-reality.types";

type BusinessRealityIconProps = {
  iconKey: BusinessRealityIconKey;
  className?: string;
};

export function BusinessRealityIcon({
  iconKey,
  className,
}: BusinessRealityIconProps) {
  const sharedProps = {
    className,
    viewBox: "0 0 32 32",
    fill: "none",
